...
/// 0.15.0: VAD anti-hallucination (0.13), paragraph splitting (0.14), and the
/// transcript timeline (0.15) all changed note output, so anything older is worth
/// re-generating.
let noteQualityBaseline = "0.15.0"
