...
/// 0.17.0: VAD anti-hallucination (0.13), paragraph splitting (0.14), the
/// transcript timeline (0.15), and the Obsidian audio embeds + tags (0.17) all
/// changed note output, so anything older is worth re-generating.
let noteQualityBaseline = "0.17.0"
